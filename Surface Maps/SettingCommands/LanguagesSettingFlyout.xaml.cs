...
namespace Surface_Maps.SettingCommands
{
    public sealed partial class LanguagesSettingFlyout : Common.LayoutAwarePage
    {
        ...
        {
            Utils.Helper.CreateToastNotifications("");
        }
        ...
        private async void Button_English(object sender, TappedRoutedEventArgs e)
        {
            ...
            Utils.Helper.CreateToastNotifications("You have just set the application language to English");
        ...
        private async void Button_Zhongwen(object sender, TappedRoutedEventArgs e)
        {
            ...
            Utils.Helper.CreateToastNotifications("您刚刚将应用程序语言改为中文");
        ...
        private async void Button_Francais(object sender, TappedRoutedEventArgs e)
        {
            ...
            Utils.Helper.CreateToastNotifications("Vous venez de choisir la langue français pour être la langue d'application!");
